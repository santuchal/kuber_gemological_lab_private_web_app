...
<form  method="post" name="login" id="login" enctype="multipart/form-data">
 ...
 <tr>
  ...
  <tr>
    ...
    <td><input name="weight" type="text"  placeholder="Enter Weight" required value="<?php echo @$row['weight'];?>" ></td>
	<td><select name="weight_type"><option value="carat">Carat</option><option value="rati">Rati</option><option value="mg">Miligram</option><option value="cent">Cent</option></select></td>
  </tr>
  <tr>
