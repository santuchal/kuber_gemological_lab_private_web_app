...
imagefttext($image1, 30, 0, 285, 290, $red, 'mono.ttf', $name);
imagefttext($image1, 30, 0, 770, 290, $red, 'mono.ttf', $create_date);
imagefttext($image1, 30, 0, 285, 335, $red, 'mono.ttf', $weight);	
imagefttext($image1, 30, 0, 285, 370, $red, 'mono.ttf', $measurement);	
imagefttext($image1, 30, 0, 285, 410, $red, 'mono.ttf', $gravity);
imagefttext($image1, 30, 0, 285, 445, $red, 'mono.ttf', $ri);
imagefttext($image1, 30, 0, 285, 475, $red, 'mono.ttf', $color);
imagefttext($image1, 30, 0, 285, 520, $red, 'mono.ttf', $clarity);	
imagefttext($image1, 30, 0, 285, 555, $red, 'mono.ttf', $cut);	
imagefttext($image1, 30, 0, 285, 595, $red, 'mono.ttf', $remarks);
imagefttext($image1, 30, 0, 835, 180, $red, 'mono.ttf', $random_id);
